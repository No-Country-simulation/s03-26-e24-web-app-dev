...
const mockTestimonials: Testimony[] = [
  ...
  },
  {
    ...
    extendedBody:
      "Mi historia completa comenzó cuando decidí cambiar de carrera...",
  ...
  },
  {
    ...
    extendedBody:
      "Todo comenzó cuando mi empresa buscaba candidatos internos...",
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="mb-12 text-center">
        ...
        <h1
          className="mb-4 animate-fade-in-up text-4xl font-display font-normal tracking-tight sm:text-5xl md:text-6xl"
          style={{ animationDelay: "0.1s" }}
        >
          Lo que dicen nuestros estudiantes
        </h1>
        <p
          className="mx-auto max-w-2xl animate-fade-in-up text-lg text-muted-foreground"
          style={{ animationDelay: "0.2s" }}
        >
          Descubre cómo nuestra plataforma ha transformado la carrera
          profesional de miles de estudiantes alrededor del mundo.
        </p>
      </div>
      ...
      <div className="mt-16 overflow-hidden rounded-2xl bg-gradient-to-br from-primary/5 via-accent/5 to-primary/10 p-8 shadow-sm backdrop-blur-sm">
        <div className="grid gap-8 text-center sm:grid-cols-3">
          <div className="group">
            <p className="mb-2 text-5xl font-display font-normal text-primary transition-transform duration-300 group-hover:scale-110">
              500+
            </p>
